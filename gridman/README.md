# 财税调度中枢（FinTax Dispatch Hub）· 独立技能（S-019）

> 治理编号：S-019 | 独立部署（非套件）| 2026-09-01 由「古立特/Gridman」按业务职能更名为「财税调度中枢」，保留 Gridman 向后兼容触发别名。

财税调度中枢的知识指引层。34 个专业模块，覆盖会计准则、税法、审计、内控、内审、投行、ESG、政府会计、财务造假识别、经济法等全领域。
